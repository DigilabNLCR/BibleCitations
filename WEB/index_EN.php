...
<head>
    ...
    <title>Biblické citáty v tisku 30. let - Home</title>
...
<body>
    <!-- MENU -->    
    <?php include "html_en/menu.html"; ?>

    <!-- CONTENTS -->
    <?php include "html_en/home.html"; ?>

    <!-- FOOTER -->
    <?php include "html_en/footer.html"; ?>

    <!-- SCRIPTS -->
    <?php include "html_en/scripts.html"; ?>
    ...
    <script type="module" src="plot_data.js"></script>
    <?php include "cookies/cookies_settings.html"; ?>
</body>
</html>